...
class TestFundamentalAgent(unittest.IsolatedAsyncioTestCase):
    ...
    @patch("bot.fundamental_agent.FundamentalAgent.get_fundamentals", new_callable=AsyncMock)
    ...
    @patch("bot.fundamental_agent.FundamentalAgent.evaluate_health", new_callable=AsyncMock)
    @patch("bot.fundamental_agent.FundamentalAgent.fetch_annual_financials", new_callable=AsyncMock)
    @patch("bot.fundamental_agent.FundamentalAgent._fetch_fmp", new_callable=AsyncMock)
    async def test_evaluate_deep_health_fcore(self, mock_fmp, mock_financials, mock_health):
